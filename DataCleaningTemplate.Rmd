...
<div id="answer">
The relationship between body-fat and density for the Equations (\@ref(eq:brozek) and \@ref(eq:siri)) is a linear relationship and negative. The body fat linearly decreases as the density increases. 
